...
package org.apache.pekko.persistence.inmemory.query.javadsl
...
import org.apache.pekko.persistence.inmemory.query.scaladsl.{ InMemoryReadJournal => ScalaInMemoryReadJournal }
